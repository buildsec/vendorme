...
Vendorme takes a basic definition of what you want to vendor, and how to validate it.  It will then go through your file - see [https://github.com/trmiller/vendorme/example/vendor.yaml](example)
